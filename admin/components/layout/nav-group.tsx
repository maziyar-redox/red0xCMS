        ...
        <SidebarGroup>
            ...
            <SidebarMenu>
                {items.map((item) => {
                    ...
                    if ("url" in item && !item.items) return <SidebarMenuLink key={key} item={item as NavLink} href={href} />
                ...
                <CollapsibleContent className="CollapsibleContent">
                    <SidebarMenuSub>
                        {item.items.map((subItem) => (
                            ...
                            >
                                <Link prefetch={false} href={subItem.url} onClick={() => setOpenMobile(false)}>
...
function checkIsActive(href: string, item: NavItem, mainNav = false) {
    const urlItem = typeof(item.url) === "undefined" ? "/" : item.url.toString();
    return (
